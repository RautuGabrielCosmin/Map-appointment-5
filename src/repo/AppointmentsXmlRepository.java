    ...
    protected void readFromFile() throws ExceptionRepository {
        try {
            ...
            TypeReference<List<Appointment>> listTypeReference =
                    new com.fasterxml.jackson.core.type.TypeReference<List<Appointment>>() {}; // create the type reference of the xml Appointment list
            List<Appointment> appointments = xmlMapper.readValue(xmlFileToReadFrom, listTypeReference); ////deseralize the entire xml array into a list of Appointment objects
